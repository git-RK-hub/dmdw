...
if (signup) {
  console.log("signup");
  var doc = document.querySelector(".sign-button");
  doc.addEventListener("click", /*#__PURE__*/function () {
...
if (login) {
  var _doc = document.querySelector(".login-button");

  _doc.addEventListener("click", /*#__PURE__*/function () {
